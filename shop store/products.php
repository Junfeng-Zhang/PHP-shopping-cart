...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Laptop Gaming Store!</h1>
                    <p>Please select your favourite product to the Cart list!</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product1.jpg" alt="Alien">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Alienware - m17 R3 - 17.3</h3>
                                    <p>Price: $ 2249</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product2.jpg" alt="MSI - GS66 Raider 15.6">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>MSI - GE66 Raider 15.6</h3>
                                    <p>Price: $ 2199</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product3.jpg" alt="Razer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Razer - Blade 15 Base - 15.6</h3>
                                    <small><s class=>$1799</s></small>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product4.jpg" alt="Acer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Acer - Predator Helios 300</h3>
                                    <small><s class=>$1725</s></small>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product5.jpg" alt="Dell">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dell - G7 17.3</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product6.jpg" alt="Asus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>ASUS - ROG Zephyrus G14</h3>
                                    <small><s class=>$1449</s></small>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product7.jpg" alt="HP OMEN">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>HP OMEN - 15.6</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product8.jpg" alt="Lenovo">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lenovo - Legion 5 15</h3>
                                    <small><s class=>$1099</s></small>
